...
<title>Staff Login - Student Counselling System</title>
...
<div class="login-card">
    ...
    <div class="subtitle">Access the Counsellor Dashboard</div>

    <form action="staff_login_action.jsp" method="post">
