...
<title>HOD Login - Student Counselling System</title>
...
.login-icon{
    ...
    color:#fff;
    font-size:34px;
    box-shadow:0 12px 28px rgba(147,51,234,.35);
}
...
<div class="login-card">
    ...
    <h2>HOD Login</h2>
    <div class="subtitle">Access the Head of Department dashboard</div>

    <form action="userauthentication.jsp" method="post">

        <input type="hidden" name="usertype" value="hod">
